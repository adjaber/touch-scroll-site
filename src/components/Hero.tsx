    ...
    <section id="home" className="relative min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <div className="grid grid-cols-2 grid-rows-2 h-full w-full">
          {/* Algiers - Using a verified high-quality image */}
          <div className="bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1525136398497-599c7ca0ebe1?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80')" }}></div>
          {/* Dubai */}
